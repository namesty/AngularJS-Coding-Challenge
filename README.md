...
app/                  --> all of the source files for the application
  ...
  trip-form/                --> the trip-form view template and logic
    trip-form.html            --> the partial template
    trip-form.js              --> the controller logic
    trip-form_test.js         --> tests of the controller
  trip-view/                --> the trip-view view template and logic
    trip-view.html            --> the partial template
    trip-view.js              --> the controller logic
    trip-view_test.js         --> tests of the controller
